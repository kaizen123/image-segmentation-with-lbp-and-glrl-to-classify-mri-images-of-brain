...
for i = 1:n
    ...
    X4 = d + "T2 MRI (" + i + ").jpg";
    try
        [SRE,LRE,GLN,RP,RLN,LGRE,HGRE,SRLGE,SRHGE,LRLGE,LRHGE,con,cor,energy,hom] = datah5(X1,X2,X3,X4);
    
        k = [k;SRE,LRE,GLN,RP,RLN,LGRE,HGRE,SRLGE,SRHGE,LRLGE,LRHGE,con,cor,energy,hom "HG"];
    catch
        disp(i);
...
for i = 1:n1
    ...
    try
        [SRE,LRE,GLN,RP,RLN,LGRE,HGRE,SRLGE,SRHGE,LRLGE,LRHGE,con,cor,energy,hom] = datah5(X1,X2,X3,X4);
        k = [k;SRE,LRE,GLN,RP,RLN,LGRE,HGRE,SRLGE,SRHGE,LRLGE,LRHGE,con,cor,energy,hom "LG"];
    catch
        disp(i);
%         fprintf('Inconsistent data in iteration %d, skipped.\n', i);
    end
...
% function [SRE,LRE,GLN,RP,RLN,LGRE,HGRE,SRLGE,SRHGE,LRLGE,LRHGE,con,cor,energy,hom] = knn(X1,X2,X3,X4)
% k1 = main(X1,X2);
% k2 = main(X3,X4);
% k3 = main(k1,k2);
% k4 = segmentation(k3);
