...
for i = 1:n
    ...
    X4 = d + "T2 MRI (" + i + ").jpg";
    try
        [Fcoarseness,Fcontrast,Fdirection] = datah1(X1,X2,X3,X4);
        k = [k;Fcoarseness Fcontrast Fdirection "HG"];
    catch
        disp(i);
...
for i = 1:n1
    ...
    try
        [Fcoarseness,Fcontrast,Fdirection] = datah1(X1,X2,X3,X4);
        k = [k;Fcoarseness Fcontrast Fdirection "LG"];
    catch
        disp(i);
%         fprintf('Inconsistent data in iteration %d, skipped.\n', i);
    end
...
% function [Fcoarseness,Fcontrast,Fdirection] = svm(X1,X2,X3,X4)
% k1 = main(X1,X2);
% k2 = main(X3,X4);
% k3 = main(k1,k2);
% k4 = segmentation(k3);
